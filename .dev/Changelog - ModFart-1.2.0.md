...
- Ajout des Wireless Grid manquants en Curio
- Ajout des liquides/buckets/bottles manquant(e)s dans le Drain et dans le Spout
- Suppression de l'Experience Sheet qui faisait doublon avec l'Experience Plate
- La Coal Rod est de nouveau craftable
- Réparation du crafts des Pump Upgrades de Sophisticated Storage
- Suppression du doublon de Mustard Seeds Seed dans le Market
- La Creative Source Jar d'Ars Nouveau peut maintenant être récupérée
...
- **_MaJ_** - Alex's Caves (1.1.4 -> 1.1.5)
- **_MaJ_** - Alex's Mobs (1.22.8 -> 1.22.9)
- **_MaJ_** - AmbientSounds 6 (6.0.3 -> 6.0.6)
- **_MaJ_** - Amendments (1.2.8 -> 1.2.11)
- **_MaJ_** - AntiBlocksReChiseled (0.4.3 -> 0.4.4)
- **_MaJ_** - Apotheosis (7.4.0 -> 7.4.2)
- **_MaJ_** - Apothic Attributes (1.3.6 -> 1.3.7)
- **_MaJ_** - Aquaculture (2.5.2 -> 2.5.5)
- **_MaJ_** - AzureLib (2.0.30 -> 2.0.34)
- **_MaJ_** - Balm (7.3.6 -> 7.3.9)
- **_MaJ_** - Better Archeology (1.1.9 -> 1.2.1)
- **_MaJ_** - Better chunk loading (4.3 -> 5.4)
- **_MaJ_** - Camera Mod (1.0.12 -> 1.0.14)
- **_MaJ_** - Chat Heads (0.12.10 -> 0.13.0)
- **_MaJ_** - Citadel (2.5.6 -> 2.6.0)
- **_MaJ_** - Collective (7.81 -> 7.84)
- **_MaJ_** - Colorful Hearts (4.3.14 -> 4.3.15)
- **_MaJ_** - Connected Glass (1.1.11 -> 1.1.12)
- **_MaJ_** - Corpse (1.0.12 -> 1.0.14)
- **_MaJ_** - CraterLib (2.0.3 -> 2.1.0)
- **_MaJ_** - Create (0.5.1.f -> 0.5.1.h)
- **_MaJ_** - Create Crafts & Additions (1.2.4d -> 1.2.4e)
- **_MaJ_** - Create Encased (1.6.1-fix1 -> 1.6.1-fix3)
- **_MaJ_** - Create Jetpack (4.2.1 -> 4.3.0)
- **_MaJ_** - Create Sifting (1.8.1.e -> 1.8.2.h)
- **_MaJ_** - Create: Interiors (0.5.4 -> 0.5.6)
- **_MaJ_** - Create: Steam 'n' Rails (1.6.4 -> 1.6.5)
- **_MaJ_** - CreativeCore (2.11.33 -> 2.11.37)
- **_MaJ_** - Cucumber Library (7.0.11 -> 7.0.12)
...
- **_MaJ_** - Embeddium (0.3.28 -> 0.3.31)
- **_MaJ_** - Endless Biomes (1.5.1 -> 1.6.0)
- **_MaJ_** - Entangled (1.3.18 -> 1.3.19)
- **_MaJ_** - Entity Culling (1.6.6 -> 1.7.0)
- **_MaJ_** - FancyMenu (3.2.3 -> 3.4.6)
