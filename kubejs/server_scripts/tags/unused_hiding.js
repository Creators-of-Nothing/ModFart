...
var unused_minecraft = [
    'minecraft:debug_stick',
    'minecraft:structure_void'
];
var unused_moreplates = [
...
var unused_global = [
    ...
    unused_create,
    unused_cyclic,
    unused_dustrial_decor,
    unused_eidolon,
    unused_samurai_dynasty,
    unused_extendedcrafting,
    unused_farmingforblockheads,
    unused_ironfurnaces,
    unused_itemfilters,
    unused_libraryferret,
    unused_mekanism,
    unused_minecraft,
    unused_moreplates,
    unused_naturalist,
    unused_pamhc2,
    unused_refinedstorage,
    unused_stalwart_dungeons,
    unused_twilightforest,
    unused_vct,
    unused_waystones
]

// Hiding Items
var hiding_apotheosis = [
    /apotheosis:gem/
];
var hiding_ars_nouveau = [
...
var hiding_everlastingabilities = [
    /everlastingabilities:ability_totem/
];
var hiding_fluxnetworks = [
    'fluxnetworks:admin_configurator'
];
var hiding_ftbquests = [
    /ftbquests:/
];
var hiding_manyideas = [
...
var hiding_structure_gel = [
    /structure_gel:/
];
var hiding_supplementaries = [
...
var hiding_global = [
    ...
    hiding_minecraft,
    hiding_nifty,
    hiding_refined_storage,
    hiding_sophisticated,
    hiding_structure_gel,
    hiding_supplementaries,
    hiding_trofers
];
...
ServerEvents.tags('item', e => {
    e.removeAllTagsFrom(unused_global)
    e.add('forge:unused', unused_global)
    e.add('forge:hiding', hiding_global)
})
