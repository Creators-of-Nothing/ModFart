...
ServerEvents.recipes(e => {
    ...
    potting('ars_nouveau:blue_archwood_sapling', 'ars_nouveau:blue_archwood_log', 'ars_nouveau:blue_archwood_leaves')
    potting('ars_nouveau:red_archwood_sapling', 'ars_nouveau:red_archwood_log', 'ars_nouveau:red_archwood_leaves')
    potting('ars_nouveau:purple_archwood_sapling', 'ars_nouveau:purple_archwood_log', 'ars_nouveau:purple_archwood_leaves')
    potting('ars_nouveau:green_archwood_sapling', 'ars_nouveau:green_archwood_log', 'ars_nouveau:green_archwood_leaves')
