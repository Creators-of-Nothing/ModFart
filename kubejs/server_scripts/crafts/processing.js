...
ServerEvents.recipes(e => {
  ...
  e.replaceInput(
    { input: "createaddition:diamond_grit" },
  ...
  // Fluorite
  e.remove({
    not: { id: "mekanism:processing/fluorite/from_block" },
    id: /mekanism:processing\/fluorite/
  })
  ...
  e.remove({ id: /samurai_dynasty:silver_ingot_from_blasting/ })
  e.remove({ id: /samurai_dynasty:silver_ingot_from_smelting/ })
  e.replaceInput({ input: "mekanism:ingot_silver" }, "mekanism:ingot_silver", "samurai_dynasty:silver_ingot")

  // Steel
  e.replaceInput(
    { input: "samurai_dynasty:steel_nugget" },
    "samurai_dynasty:steel_nugget",
    "mekanism:nugget_steel"
  )
  e.replaceInput(
    { input: "samurai_dynasty:steel_ingot" },
    "samurai_dynasty:steel_ingot",
    "mekanism:ingot_steel"
  )
  e.replaceInput(
    { input: "samurai_dynasty:steel_block" },
  ...
  e.replaceOutput(
    { output: "moremekanismprocessing:zinc_ingot" },
...
ServerEvents.recipes(e => {
  ...
  potting("ancient_aether:valkyrum_ore", "ancient_aether:valkyrum")
  ...
  potting("eidolon:deep_lead_ore", "mekanism:raw_lead")
  potting("eidolon:deep_silver_ore", "samurai_dynasty:raw_silver")
  potting("eidolon:lead_ore", "mekanism:raw_lead")
  potting("eidolon:silver_ore", "samurai_dynasty:raw_silver")
  ...
  potting("samurai_dynasty:aquamarine_ore", "kubejs:raw_aquamarine")
  potting("samurai_dynasty:deepslate_aquamarine_ore", "kubejs:raw_aquamarine")
  potting("samurai_dynasty:deepslate_jade_ore", "kubejs:raw_jade")
  potting("samurai_dynasty:deepslate_onyx_ore", "kubejs:raw_onyx")
  potting("samurai_dynasty:deepslate_ruby_ore", "kubejs:raw_ruby")
  potting("samurai_dynasty:deepslate_silver_ore", "samurai_dynasty:raw_silver")
  potting("samurai_dynasty:jade_ore", "kubejs:raw_jade")
  potting("samurai_dynasty:onyx_ore", "kubejs:raw_onyx")
  potting("samurai_dynasty:ruby_ore", "kubejs:raw_ruby")
  potting("samurai_dynasty:silver_ore", "samurai_dynasty:raw_silver")
...
ServerEvents.recipes(e => {
  ...
  potting("forge:ores/silver", "samurai_dynasty:raw_silver")
  ...
  potting("forge:ores/valkyrum", "ancient_aether:valkyrum")
})
ServerEvents.recipes(e => {
  let potting = (input, output) => {
    e.custom({
...
ServerEvents.recipes(e => {
  ...
  potting("samurai_dynasty:raw_silver", "kubejs:clump_silver")
...
ServerEvents.recipes(e => {
  ...
  potting("kubejs:raw_ruby", "1", 0.7, "samurai_dynasty:ruby")
  potting("kubejs:clump_ruby", "2", 1.4, "samurai_dynasty:ruby")
  potting("kubejs:shard_ruby", "3", 2.1, "samurai_dynasty:ruby")
  potting("kubejs:dirty_dust_ruby", "4", 2.8, "samurai_dynasty:ruby")
  potting("kubejs:dust_ruby", "5", 3.5, "samurai_dynasty:ruby")
  potting("kubejs:crystal_ruby", "6", 4.2, "samurai_dynasty:ruby")
  potting("kubejs:raw_jade", "1", 0.7, "samurai_dynasty:jade")
  potting("kubejs:clump_jade", "2", 1.4, "samurai_dynasty:jade")
  potting("kubejs:shard_jade", "3", 2.1, "samurai_dynasty:jade")
  potting("kubejs:dirty_dust_jade", "4", 2.8, "samurai_dynasty:jade")
  potting("kubejs:dust_jade", "5", 3.5, "samurai_dynasty:jade")
  potting("kubejs:crystal_jade", "6", 4.2, "samurai_dynasty:jade")
  potting("kubejs:raw_aquamarine", "1", 0.7, "samurai_dynasty:aquamarine")
  potting("kubejs:clump_aquamarine", "2", 1.4, "samurai_dynasty:aquamarine")
  potting("kubejs:shard_aquamarine", "3", 2.1, "samurai_dynasty:aquamarine")
  potting("kubejs:dirty_dust_aquamarine", "4", 2.8, "samurai_dynasty:aquamarine")
  potting("kubejs:dust_aquamarine", "5", 3.5, "samurai_dynasty:aquamarine")
  potting("kubejs:crystal_aquamarine", "6", 4.2, "samurai_dynasty:aquamarine")
  potting("kubejs:raw_onyx", "1", 0.7, "samurai_dynasty:onyx")
  potting("kubejs:clump_onyx", "2", 1.4, "samurai_dynasty:onyx")
  potting("kubejs:shard_onyx", "3", 2.1, "samurai_dynasty:onyx")
  potting("kubejs:dirty_dust_onyx", "4", 2.8, "samurai_dynasty:onyx")
  potting("kubejs:dust_onyx", "5", 3.5, "samurai_dynasty:onyx")
  potting("kubejs:crystal_onyx", "6", 4.2, "samurai_dynasty:onyx")
  potting("samurai_dynasty:raw_silver", "1", 0.7, "samurai_dynasty:silver_ingot")
  potting("kubejs:clump_silver", "2", 1.4, "samurai_dynasty:silver_ingot")
  potting("kubejs:shard_silver", "3", 2.1, "samurai_dynasty:silver_ingot")
  potting("kubejs:dirty_dust_silver", "4", 2.8, "samurai_dynasty:silver_ingot")
  potting("kubejs:dust_silver", "5", 3.5, "samurai_dynasty:silver_ingot")
  potting("kubejs:crystal_silver", "6", 4.2, "samurai_dynasty:silver_ingot")
...
ServerEvents.recipes(e => {
  ...
  potting("samurai_dynasty:ruby", 15, "minecraft:stone", "samurai_dynasty:ruby_ore")
  potting("samurai_dynasty:ruby", 15, "minecraft:deepslate", "samurai_dynasty:deepslate_ruby_ore")
  potting("samurai_dynasty:jade", 15, "minecraft:stone", "samurai_dynasty:jade_ore")
  potting("samurai_dynasty:jade", 15, "minecraft:deepslate", "samurai_dynasty:deepslate_jade_ore")
  potting("samurai_dynasty:aquamarine", 15, "minecraft:stone", "samurai_dynasty:aquamarine_ore")
  potting("samurai_dynasty:aquamarine", 15, "minecraft:deepslate", "samurai_dynasty:deepslate_aquamarine_ore")
  potting("samurai_dynasty:onyx", 15, "minecraft:stone", "samurai_dynasty:onyx_ore")
  potting("samurai_dynasty:onyx", 15, "minecraft:deepslate", "samurai_dynasty:deepslate_onyx_ore")
  potting("samurai_dynasty:silver_ingot", 15, "minecraft:stone", "samurai_dynasty:silver_ore")
  potting("samurai_dynasty:silver_ingot", 15, "minecraft:deepslate", "samurai_dynasty:deepslate_silver_ore")
  ...
  potting(
    ...
    15,
    "stalwart_dungeons:soul_bricks",
    "stalwart_dungeons:tungsten_ore"
  )
  potting(
    "stalwart_dungeons:chorundum",
    15,
    "stalwart_dungeons:purpur_bricks",
    "stalwart_dungeons:chorundum_ore"
  )
  potting("ancient_aether:valkyrum", 1, "aether:holystone", "ancient_aether:valkyrum_ore")
