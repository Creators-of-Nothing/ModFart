...
ServerEvents.recipes(e => {
    ...
    potting('ringsofascension:ring_flight', 'alexsmobs:void_worm_eye', 'create_jetpack:netherite_jetpack', 'deeperdarker:soul_elytra', 'the_bumblezone:pollen_puff', 'eidolon:raven_cloak', 'ars_nouveau:ritual_flight', 'lolenderite:enderite_plated_elytra', 'mekanism:jetpack_armored')
    potting('ringsofascension:ring_growth', 'vinery:straw_hat', 'pamhc2foodcore:freshwateritem', 'vinery:winemaker_leggings', 'ars_nouveau:ritual_overgrowth', 'vinery:winemaker_boots', 'meadow:watering_can', 'vinery:winemaker_apron', 'arcanelanterns:life_lantern')
    potting('ringsofascension:ring_health', 'paraglider:heart_container', 'minecraft:heart_of_the_sea', 'arcanelanterns:love_lantern', 'twilightforest:charm_of_life_2', 'deeperdarker:heart_of_the_deep', 'alexsmobs:soul_heart', 'ars_elemental:anima_essence', 'candlelight:hearth')
    ...
    potting('ringsofascension:ring_invisibility', 'ars_nouveau:glyph_invisibility', 'skinnedlanterns:ghost_soul_lantern_block', 'moa_decor_toys:vex', 'nourished_nether:ectoplasm', 'aether:invisibility_cloak', 'moa_decor_holidays:fantasma', 'moa_decor_toys:vex', 'skinnedlanterns:ghost_lantern_block')
    potting('ringsofascension:ring_jump_boost', 'minecraft:white_bed', 'minecraft:rabbit_foot', 'create_things_and_misc:sticky_launcher', 'alexsmobs:flying_fish_boots', 'farmersdelight:horse_feed', 'create_things_and_misc:sticky_boots_boots', 'create_things_and_misc:brass_sticky_launcher', 'vinery:clark_wine')
    ...
    potting('ringsofascension:ring_night_vision', 'vinery:aegis_wine', 'cataclysm:void_eye', 'cataclysm:flame_eye', 'cataclysm:monstrous_eye', 'cataclysm:desert_eye', 'cataclysm:mech_eye', 'minecraft:ender_eye', 'cataclysm:abyss_eye')
    ...
    potting('ringsofascension:ring_steadfast_steps', 'beachparty:sunglasses', 'supplementaries:rope_arrow', 'alexsmobs:roadrunner_boots', 'minecraft:ladder', 'samurai_dynasty:steel_ninja_boots', 'nourished_nether:gilded_blackstone_brick_stairs', 'pizzacraft:pizza_delivery_boots', 'meadow:climbing_rope_topmount')
    ...
    potting('ringsofascension:ring_undying', 'fantasyfurniture:decorations/gravestone', 'minecraft:respawn_anchor', 'moa_decor_garden_:pala_cgrava', 'supplementaries:raked_gravel', 'minecraft:totem_of_undying', 'nourished_nether:necronium_block', 'ars_nouveau:thread_undying', 'minecraft:respawn_anchor')
