...
ServerEvents.recipes(e => {
  ...
  //#region - Minecraft
  potting_cagedmobs("minecraft:bee", "overworld", false, 2, ["minecraft:honeycomb", "cagedmobs:honey_drop"])
  ...
  potting_cagedmobs("minecraft:cave_spider", "overworld", false, 2, [
    "minecraft:string",
    "minecraft:spider_eye"
  ])
  potting_cagedmobs("minecraft:chicken", "overworld", false, 1, [
    "minecraft:feather",
    "minecraft:chicken",
    "minecraft:egg"
  ])
  potting_cagedmobs("minecraft:cod", "sea", true, 1, ["minecraft:cod", "minecraft:bone_meal"])
  potting_cagedmobs("minecraft:cow", "overworld", false, 1, [
    "minecraft:leather",
    "minecraft:beef",
    "cagedmobs:milk_drop"
  ])
  ...
  potting_cagedmobs("minecraft:drowned", "sea", true, 1, [
  ...
  potting_cagedmobs("minecraft:elder_guardian", "sea", true, 3, [
    "oceansdelight:elder_guardian_slab",
    "cagedmobs:sponge_fragment"
  ])
  potting_cagedmobs("minecraft:ender_dragon", "end", false, 3, [
    "ends_delight:dragon_tooth",
    "ends_delight:dragon_leg",
    "cagedmobs:dragon_scale",
    "minecraft:dragon_head"
  ])
  potting_cagedmobs("minecraft:enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endersdelight:enderman_sight",
    "ends_delight:enderman_gristle"
  ])
  potting_cagedmobs("minecraft:endermite", "end", false, 2, [
    "minecraft:end_stone",
    "ends_delight:raw_ender_mite_meat",
    "endersdelight:mite_crust"
  ])
  potting_cagedmobs("minecraft:evoker", "overworld", false, 2, [
    "minecraft:emerald",
    "minecraft:totem_of_undying"
  ])
  potting_cagedmobs("minecraft:frog", "overworld", false, 1, [
  ...
  potting_cagedmobs("minecraft:hoglin", "nether", false, 2, [
    "minecraft:leather",
    "minecraft:porkchop",
    "farmersdelight:ham",
  ...
  potting_cagedmobs("minecraft:husk", "overworld", false, 2, [
    "minecraft:rotten_flesh",
  ...
  potting_cagedmobs("minecraft:iron_golem", "overworld", false, 2, [
    "minecraft:iron_ingot",
    "minecraft:poppy"
  ])
  ...
  potting_cagedmobs("minecraft:rabbit", "overworld", false, 1, [
  ...
  potting_cagedmobs("minecraft:sheep", "overworld", false, 1, [
    "minecraft:mutton",
  ...
  potting_cagedmobs("minecraft:shulker", "end", false, 2, [
  ...
  potting_cagedmobs("minecraft:skeleton", "overworld", false, 2, [
    "minecraft:bone",
    "minecraft:arrow",
    "minecraft:bow"
  ])
  potting_cagedmobs("minecraft:slime", "overworld", false, 2, ["minecraft:slime_ball"])
  potting_cagedmobs("minecraft:sniffer", "overworld", false, 1, [
  ...
  potting_cagedmobs("minecraft:stray", "overworld", false, 2, [
    "minecraft:bone",
    "minecraft:arrow",
    "minecraft:bow"
  ])
  potting_cagedmobs("minecraft:strider", "nether", false, 1, [
    "minecraft:string",
    "nethersdelight:strider_slice"
  ])
  potting_cagedmobs("minecraft:trader_llama", "overworld", false, 1, ["minecraft:leather"])
  potting_cagedmobs("minecraft:tropical_fish", "sea", true, 1, [
    "minecraft:tropical_fish",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("minecraft:turtle", "sea", true, 1, [
    "minecraft:seagrass",
    "minecraft:scute",
    "minecraft:turtle_egg"
  ])
  potting_cagedmobs("minecraft:vindicator", "overworld", false, 2, ["minecraft:emerald"])
  potting_cagedmobs("minecraft:warden", "overworld", false, 3, [
    "minecraft:sculk_catalyst",
    "apotheosis:warden_tendril",
    "deeperdarker:heart_of_the_deep"
  ])
  potting_cagedmobs("minecraft:witch", "overworld", false, 2, [
  ...
  potting_cagedmobs("minecraft:wither_skeleton", "nether", false, 2, [
    "minecraft:coal",
    "minecraft:bone",
    "minecraft:wither_skeleton_skull"
  ])
  potting_cagedmobs("minecraft:wither", "nether", false, 3, [
  ...
  potting_cagedmobs("minecraft:zombie_villager", "overworld", false, 2, [
    "minecraft:rotten_flesh",
    "minecraft:iron_ingot",
    "minecraft:carrot",
    "minecraft:potato",
  ...
  potting_cagedmobs("minecraft:zombie", "overworld", false, 2, [
    "minecraft:rotten_flesh",
    "minecraft:iron_ingot",
    "minecraft:carrot",
    "minecraft:potato",
  ...
  potting_cagedmobs("minecraft:zombified_piglin", "nether", false, 2, [
    "minecraft:rotten_flesh",
  ...
  //#endregion
  //#region - Alex's Caves
  potting_cagedmobs("alexscaves:boundroid", "overworld", false, 2, [
    "alexscaves:heavyweight",
    "minecraft:chain"
  ])
  potting_cagedmobs("alexscaves:corrodent", "overworld", false, 2, [
  ...
  potting_cagedmobs("alexscaves:grottoceratops", "overworld", false, 2, [
  ...
  potting_cagedmobs("alexscaves:nucleeper", "overworld", false, 2, [
  ...
  potting_cagedmobs("alexscaves:relicheirus", "overworld", false, 2, [
    "alexscaves:heavy_bone",
    "alexscaves:dinosaur_chop",
    "minecraft:feather"
  ])
  potting_cagedmobs("alexscaves:sea_pig", "overworld", false, 1, ["alexscaves:sea_pig"])
  potting_cagedmobs("alexscaves:tremorsaurus", "overworld", false, 2, [
    "alexscaves:heavy_bone",
    "alexscaves:dinosaur_chop"
  ])
  potting_cagedmobs("alexscaves:tremorzilla", "overworld", false, 2, [
  ...
  potting_cagedmobs("alexscaves:vesper", "overworld", false, 2, [
    "alexscaves:guano",
    "alexscaves:vesper_wing"
  ])
  potting_cagedmobs("alexscaves:watcher", "overworld", false, 2, [
    "alexscaves:dark_tatters",
    "alexscaves:occult_gem"
  ])
  //#endregion
  //#region - Alex's Mobs
  potting_cagedmobs("alexscaves:brainiac", "overworld", false, 2, [
    "alexscaves:green_soylent",
    "minecraft:rotten_flesh",
    "alexscaves:charred_remnant"
  ])
  potting_cagedmobs("alexscaves:hullbreaker", "overworld", false, 2, [
    "alexscaves:sea_glass_shards",
    "minecraft:copper_ingot",
    "alexscaves:enigmatic_engine"
  ])
  potting_cagedmobs("alexscaves:teletor", "overworld", false, 2, [
    "alexscaves:raw_azure_neodymium",
    "alexscaves:raw_scarlet_neodymium",
    "alexscaves:telecore"
  ])
  potting_cagedmobs("alexsmobs:alligator_snapping_turtle", "sea", true, 1, [
  ...
  potting_cagedmobs("alexsmobs:bone_serpent", "nether", false, 2, [
  ...
  potting_cagedmobs("alexsmobs:cachalot_whale", "sea", true, 1, [
  ...
  potting_cagedmobs("alexsmobs:cockroach", "overworld", false, 1, [
  ...
  potting_cagedmobs("alexsmobs:cosmic_cod", "overworld", false, 1, [
    "alexsmobs:cosmic_cod",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("alexsmobs:crimson_mosquito", "nether", false, 2, [
    "alexsmobs:blood_sac",
    "alexsmobs:mosquito_proboscis"
  ])
  potting_cagedmobs("alexsmobs:crocodile", "sea", true, 2, [
  ...
  potting_cagedmobs("alexsmobs:elephant", "overworld", false, 1, [
    "alexsmobs:acacia_blossom",
    "minecraft:acacia_leaves"
  ])
  potting_cagedmobs("alexsmobs:emu", "overworld", false, 1, [
  ...
  potting_cagedmobs("alexsmobs:frilled_shark", "sea", true, 2, [
    "alexsmobs:crocodile_scute",
    "alexsmobs:crocodile_egg"
  ])
  potting_cagedmobs("alexsmobs:frilled_shark", "sea", true, 2, ["alexsmobs:serrated_shark_tooth"])
  potting_cagedmobs("alexsmobs:froststalker", "overworld", false, 2, [
    "alexsmobs:froststalker_horn",
    "minecraft:packed_ice",
    "minecraft:blue_ice"
  ])
  potting_cagedmobs("alexsmobs:gazelle", "overworld", false, 1, [
  ...
  potting_cagedmobs("alexsmobs:grizzly_bear", "overworld", false, 2, [
    "alexsmobs:bear_fur",
    "alexsmobs:bear_dust"
  ])
  potting_cagedmobs("alexsmobs:guster", "overworld", false, 2, [
  ...
  potting_cagedmobs("alexsmobs:kangaroo", "overworld", false, 1, [
  ...
  potting_cagedmobs("alexsmobs:laviathan", "nether", false, 2, [
    "minecraft:magma_block",
    "minecraft:blackstone",
    "minecraft:obsidian"
  ])
  potting_cagedmobs("alexsmobs:leafcutter_ant", "overworld", false, 1, [
  ...
  potting_cagedmobs("alexsmobs:moose", "overworld", false, 1, [
    "alexsmobs:moose_antler",
    "alexsmobs:moose_ribs"
  ])
  potting_cagedmobs("alexsmobs:mudskipper", "sea", true, 1, ["minecraft:tropical_fish"])
  potting_cagedmobs("alexsmobs:mungus", "overworld", false, 2, [
    "minecraft:red_mushroom",
    "minecraft:brown_mushroom",
    "minecraft:crimson_fungus",
    "minecraft:warped_fungus"
  ])
  potting_cagedmobs("alexsmobs:murmur", "overworld", false, 2, [
    "alexsmobs:elastic_tendon",
    "minecraft:red_wool"
  ])
  potting_cagedmobs("alexsmobs:platypus", "overworld", false, 2, [
    "alexsmobs:maggot",
    "minecraft:clay_ball",
    "alexsmobs:fedora"
  ])
  ...
  potting_cagedmobs("alexsmobs:roadrunner", "overworld", false, 1, [
    "alexsmobs:roadrunner_feather",
    "minecraft:feather"
  ])
  potting_cagedmobs("alexsmobs:rocky_roller", "overworld", false, 2, [
    "alexsmobs:rocky_shell",
    "minecraft:pointed_dripstone",
    "minecraft:tuff"
  ])
  potting_cagedmobs("alexsmobs:seagull", "overworld", false, 1, ["minecraft:feather"])
  potting_cagedmobs("alexsmobs:seal", "sea", true, 1, [
    "minecraft:kelp",
    "minecraft:nautilus_shell",
    "minecraft:scute",
    "minecraft:sand"
  ...
  potting_cagedmobs("alexsmobs:soul_vulture", "nether", false, 2, [
    "minecraft:coal",
    "minecraft:bone",
  ...
  potting_cagedmobs("alexsmobs:tarantula_hawk", "overworld", false, 1, [
  ...
  potting_cagedmobs("alexsmobs:void_worm", "end", false, 3, [
    "alexsmobs:void_worm_eye",
    "alexsmobs:void_worm_mandible",
    "createutilities:void_steel_ingot"
  ])
  potting_cagedmobs("alexsmobs:warped_mosco", "nether", false, 3, [
    "alexsmobs:warped_muscle",
    "alexsmobs:hemolymph_sac"
  ])
  potting_cagedmobs("alexsmobs:warped_toad", "nether", false, 2, [
    "minecraft:shroomlight",
    "minecraft:nether_wart"
  ])
  //#endregion
  //#region - Aquaculture
  potting_cagedmobs("aquaculture:arapaima", "sea", true, 1, ["aquaculture:arapaima", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:arrau_turtle", "sea", true, 1, ["aquaculture:arrau_turtle"])
  potting_cagedmobs("aquaculture:atlantic_cod", "sea", true, 1, [
    "aquaculture:atlantic_cod",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:atlantic_halibut", "sea", true, 1, [
    "aquaculture:atlantic_halibut",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:atlantic_herring", "sea", true, 1, [
    "aquaculture:atlantic_herring",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:bayad", "sea", true, 1, ["aquaculture:bayad", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:blackfish", "sea", true, 1, ["aquaculture:blackfish", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:bluegill", "sea", true, 1, ["aquaculture:bluegill", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:boulti", "sea", true, 1, ["aquaculture:boulti", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:box_turtle", "sea", true, 1, ["aquaculture:box_turtle"])
  potting_cagedmobs("aquaculture:brown_shrooma", "sea", true, 1, [
    "aquaculture:brown_shrooma",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:brown_trout", "sea", true, 1, [
    "aquaculture:brown_trout",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:capitaine", "sea", true, 1, ["aquaculture:capitaine", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:carp", "sea", true, 1, ["aquaculture:carp", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:catfish", "sea", true, 1, ["aquaculture:catfish", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:gar", "sea", true, 1, ["aquaculture:gar", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:jellyfish", "sea", true, 1, ["aquaculture:jellyfish"])
  potting_cagedmobs("aquaculture:minnow", "sea", true, 1, ["aquaculture:minnow", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:muskellunge", "sea", true, 1, [
    "aquaculture:muskellunge",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:pacific_halibut", "sea", true, 1, [
    "aquaculture:pacific_halibut",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:perch", "sea", true, 1, ["aquaculture:perch", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:pink_salmon", "sea", true, 1, [
    "aquaculture:pink_salmon",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:piranha", "sea", true, 1, ["aquaculture:piranha", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:pollock", "sea", true, 1, ["aquaculture:pollock", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:rainbow_trout", "sea", true, 1, [
    "aquaculture:rainbow_trout",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:red_grouper", "sea", true, 1, [
    "aquaculture:red_grouper",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:red_shrooma", "sea", true, 1, [
    "aquaculture:red_shrooma",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:smallmouth_bass", "sea", true, 1, [
    "aquaculture:smallmouth_bass",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:starshell_turtle", "sea", true, 1, ["aquaculture:starshell_turtle"])
  potting_cagedmobs("aquaculture:synodontis", "sea", true, 1, [
    "aquaculture:synodontis",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("aquaculture:tambaqui", "sea", true, 1, ["aquaculture:tambaqui", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:tuna", "sea", true, 1, ["aquaculture:tuna", "minecraft:bone_meal"])
  //#endregion
  //#region - Cataclysm
  potting_cagedmobs("cataclysm:amethyst_crab", "sea", true, 2, [
    "cataclysm:amethyst_crab_meat",
    "cataclysm:amethyst_crab_shell"
  ])
  potting_cagedmobs("cataclysm:ancient_remnant", "overworld", false, 3, ["cataclysm:ancient_metal_block"])
  ...
  potting_cagedmobs("cataclysm:deepling_angler", "sea", true, 2, ["minecraft:nautilus_shell"])
  ...
  potting_cagedmobs("cataclysm:ender_guardian", "end", false, 2, ["cataclysm:gauntlet_of_guard"])
  ...
  potting_cagedmobs("creeperoverhaul:badlands_creeper", "overworld", false, 2, [
    "minecraft:gunpowder",
    "minecraft:gold_nugget"
  ])
  potting_cagedmobs("creeperoverhaul:bamboo_creeper", "overworld", false, 2, ["minecraft:bamboo"])
  potting_cagedmobs("creeperoverhaul:beach_creeper", "overworld", false, 2, [
    "minecraft:gunpowder",
    "minecraft:sand",
  ...
  potting_cagedmobs("creeperoverhaul:cave_creeper", "overworld", false, 2, [
    "minecraft:gunpowder",
    "minecraft:stone",
  ...
  potting_cagedmobs("creeperoverhaul:dark_oak_creeper", "overworld", false, 2, [
    "minecraft:gunpowder",
    "minecraft:dark_oak_log",
    "minecraft:cobweb"
  ])
  potting_cagedmobs("creeperoverhaul:desert_creeper", "overworld", false, 2, [
    "minecraft:gunpowder",
    "minecraft:cactus"
  ])
  potting_cagedmobs("creeperoverhaul:dripstone_creeper", "overworld", false, 2, [
    "minecraft:gunpowder",
    "minecraft:pointed_dripstone"
  ])
  ...
  potting_cagedmobs("creeperoverhaul:spruce_creeper", "overworld", false, 2, [
    "minecraft:gunpowder",
    "minecraft:spruce_log"
  ])
  potting_cagedmobs("creeperoverhaul:swamp_creeper", "overworld", false, 2, [
    "minecraft:gunpowder",
    "minecraft:bone"
  ])
  //#endregion
  ...
  //#endregion
  //#region - Eidolon
  potting_cagedmobs("eidolon:giant_skeleton", "overworld", false, 2, [
    "minecraft:bone",
    "eidolon:imbued_bones"
  ])
  potting_cagedmobs("eidolon:necromancer", "overworld", false, 2, ["minecraft:emerald"])
  ...
  potting_cagedmobs("eidolon:wraith", "overworld", false, 2, [
    "eidolon:tattered_cloth",
    "eidolon:wraith_heart"
  ])
  potting_cagedmobs("eidolon:zombie_brute", "overworld", false, 2, [
    "minecraft:rotten_flesh",
    "minecraft:bone",
  ...
  potting_cagedmobs("endermanoverhaul:badlands_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endermanoverhaul:tiny_skull"
  ])
  potting_cagedmobs("endermanoverhaul:cave_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "minecraft:coal",
    "minecraft:raw_iron",
    "minecraft:emerald"
  ])
  potting_cagedmobs("endermanoverhaul:coral_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endermanoverhaul:bubble_pearl"
  ])
  potting_cagedmobs("endermanoverhaul:crimson_forest_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endermanoverhaul:crimson_pearl",
    "minecraft:crimson_fungus"
  ])
  potting_cagedmobs("endermanoverhaul:dark_oak_enderman", "end", false, 2, ["minecraft:ender_pearl"])
  potting_cagedmobs("endermanoverhaul:desert_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "minecraft:emerald"
  ])
  potting_cagedmobs("endermanoverhaul:end_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endermanoverhaul:corrupted_pearl",
    "minecraft:chorus_fruit",
    "endermanoverhaul:enderman_tooth"
  ])
  potting_cagedmobs("endermanoverhaul:end_islands_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endermanoverhaul:ancient_pearl"
  ])
  potting_cagedmobs("endermanoverhaul:flower_fields_enderman", "end", false, 2, ["minecraft:ender_pearl"])
  potting_cagedmobs("endermanoverhaul:ice_spikes_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endermanoverhaul:icy_pearl",
    "minecraft:packed_ice"
  ])
  potting_cagedmobs("endermanoverhaul:mushroom_fields_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "minecraft:red_mushroom"
  ])
  potting_cagedmobs("endermanoverhaul:nether_wastes_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "minecraft:bone"
  ])
  potting_cagedmobs("endermanoverhaul:savanna_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "minecraft:acacia_log"
  ])
  potting_cagedmobs("endermanoverhaul:snowy_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endermanoverhaul:icy_pearl",
    "minecraft:snowball"
  ])
  potting_cagedmobs("endermanoverhaul:soulsand_valley_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endermanoverhaul:soul_pearl",
    "minecraft:bone"
  ])
  potting_cagedmobs("endermanoverhaul:swamp_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endermanoverhaul:summoner_pearl"
  ])
  potting_cagedmobs("endermanoverhaul:warped_forest_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endermanoverhaul:warped_pearl",
    "minecraft:warped_fungus"
  ])
  potting_cagedmobs("endermanoverhaul:windswept_hills_enderman", "end", false, 2, [
    "minecraft:ender_pearl",
    "endermanoverhaul:summoner_pearl"
  ])
  //#endregion
  //#region - Endless Biomes
  potting_cagedmobs("endlessbiomes:anklor", "end", false, 2, [
    "endlessbiomes:anklor_shell_fragments",
    "endlessbiomes:anklor_flesh"
  ])
  potting_cagedmobs("endlessbiomes:shiftling", "end", false, 1, [
    "endlessbiomes:riftite_shard",
    "endlessbiomes:shiftling_antenna"
  ])
  //#endregion
  //#region - Enlightend
  potting_cagedmobs("enlightened_end:eidolon", "overworld", false, 2, ["enlightened_end:everglint"])
  potting_cagedmobs("enlightened_end:stalker", "end", false, 2, [
    "enlightened_end:raw_stalker",
    "enlightened_end:stalker_tooth"
  ])
  //#endregion
  //#region - Fish of Thieves
  potting_cagedmobs("fishofthieves:ancientscale", "sea", true, 1, [
    "fishofthieves:ancientscale",
    "fishofthieves:fish_bone",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("fishofthieves:battlegill", "sea", true, 1, [
    "fishofthieves:battlegill",
    "fishofthieves:fish_bone",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("fishofthieves:devilfish", "sea", true, 1, [
    "fishofthieves:devilfish",
    "fishofthieves:fish_bone",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("fishofthieves:islehopper", "sea", true, 1, [
    "fishofthieves:islehopper",
    "fishofthieves:fish_bone",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("fishofthieves:plentifin", "sea", true, 1, [
    "fishofthieves:plentifin",
    "fishofthieves:fish_bone",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("fishofthieves:pondie", "sea", true, 1, [
    "fishofthieves:pondie",
    "fishofthieves:fish_bone",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("fishofthieves:splashtail", "sea", true, 1, [
    "fishofthieves:splashtail",
    "fishofthieves:fish_bone",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("fishofthieves:stormfish", "sea", true, 1, [
    "fishofthieves:stormfish",
    "fishofthieves:fish_bone",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("fishofthieves:wildsplash", "sea", true, 1, [
    "fishofthieves:wildsplash",
    "fishofthieves:fish_bone",
    "minecraft:bone_meal"
  ])
  potting_cagedmobs("fishofthieves:wrecker", "sea", true, 1, [
  ...
  //#endregion
  //#region - Monster Plus
  potting_cagedmobs("monsterplus:abyssologer", "overworld", false, 2, [
    "monsterplus:crystal_shard",
    "minecraft:obsidian",
    "minecraft:crying_obsidian"
  ])
  potting_cagedmobs("monsterplus:crystal_zombie", "overworld", false, 2, [
    "monsterplus:crystal_clump",
    "minecraft:deepslate",
    "minecraft:cobbled_deepslate",
    "monsterplus:crystal_clump"
  ])
  potting_cagedmobs("monsterplus:glow_skeleton", "overworld", false, 2, [
    "minecraft:bone",
    "minecraft:arrow",
    "minecraft:glow_ink_sac",
    "minecraft:glowstone_dust"
  ])
  potting_cagedmobs("monsterplus:lava_squid", "nether", false, 1, [
    "minecraft:blaze_powder",
    "minecraft:magma_cream"
  ])
  potting_cagedmobs("monsterplus:mother_lava_squid", "nether", false, 2, [
    "minecraft:blaze_powder",
    "minecraft:magma_cream"
  ])
  potting_cagedmobs("monsterplus:overgrown_skeleton", "overworld", false, 2, [
    "minecraft:bone",
    "minecraft:arrow",
    "minecraft:glow_berries",
    "minecraft:vine"
  ])
  potting_cagedmobs("monsterplus:swamp_zombie", "overworld", false, 2, [
    "minecraft:rotten_flesh",
    "minecraft:mud",
  ...
  potting_cagedmobs("mutantmonsters:mutant_creeper", "overworld", false, 2, [
    "minecraft:gunpowder",
    "mutantmonsters:creeper_shard"
  ])
  potting_cagedmobs("mutantmonsters:mutant_enderman", "overworld", false, 2, [
    "minecraft:ender_pearl",
    "minecraft:ender_eye",
    "mutantmonsters:endersoul_hand"
  ])
  potting_cagedmobs("mutantmonsters:mutant_skeleton", "overworld", false, 2, [
  ...
  potting_cagedmobs("mutantmonsters:mutant_snow_golem", "overworld", false, 2, ["minecraft:snow_block"])
  potting_cagedmobs("mutantmonsters:mutant_zombie", "overworld", false, 2, ["mutantmonsters:hulk_hammer"])
  potting_cagedmobs("mutantmonsters:spider_pig", "overworld", false, 2, [
    "minecraft:string",
    "minecraft:porkchop"
  ])
  //#endregion
  ...
  potting_cagedmobs("naturalist:elephant", "overworld", false, 1, ["minecraft:leather"])
  potting_cagedmobs("naturalist:firefly", "overworld", false, 1, ["naturalist:glow_goop"])
  potting_cagedmobs("naturalist:lizard_tail", "overworld", false, 1, ["naturalist:lizard_tail"])
  potting_cagedmobs("naturalist:rhino", "overworld", false, 1, ["minecraft:leather"])
  potting_cagedmobs("naturalist:robin", "overworld", false, 1, ["minecraft:feather"])
  potting_cagedmobs("naturalist:snail", "overworld", false, 1, [
    "naturalist:snail_shell",
    "minecraft:slime_ball"
  ])
  potting_cagedmobs("naturalist:vulture", "overworld", false, 1, ["minecraft:feather"])
  //#endregion
  //#region - Netherite Wardens
  potting_cagedmobs("netherite_warden:netheritewarden", "overworld", false, 3, [
  ...
  //#endregion
  //#region - Realm RPG
  potting_cagedmobs("realmrpg_wyrms:ender_wyrm", "end", false, 2, [
    "minecraft:obsidian",
    "minecraft:dragon_breath",
    "minecraft:dragon_head"
  ])
  potting_cagedmobs("realmrpg_wyrms:red_wyrm", "nether", false, 2, [
    "minecraft:magma_block",
    "minecraft:blaze_powder"
  ])
  //#endregion
  ...
  potting_cagedmobs("samurai_dynasty:enenra", "overworld", false, 2, [
    "minecraft:coal",
    "minecraft:gunpowder"
  ])
  ...
  potting_cagedmobs("samurai_dynasty:kitsune", "overworld", false, 2, [
    "samurai_dynasty:kitsune_tail",
    "samurai_dynasty:kitsune_hide"
  ])
  potting_cagedmobs("samurai_dynasty:komainu", "overworld", false, 1, ["samurai_dynasty:cloth"])
  potting_cagedmobs("samurai_dynasty:oni", "overworld", false, 2, [
    "samurai_dynasty:oni_horn",
  ...
  potting_cagedmobs("samurai_dynasty:twotailed", "overworld", false, 2, [
    "samurai_dynasty:kitsune_tail",
    "samurai_dynasty:kitsune_hide"
  ])
  //#endregion
  //#region - Stalwart Dungeons
  potting_cagedmobs("stalwart_dungeons:awful_ghast", "end", false, 3, [
    "stalwart_dungeons:awful_crystal",
    "minecraft:ghast_tear"
  ])
  potting_cagedmobs("stalwart_dungeons:giddy_blaze", "end", false, 2, [
    "minecraft:blaze_rod",
    "minecraft:nether_brick"
  ])
  potting_cagedmobs("stalwart_dungeons:incomplete_wither", "end", false, 2, [
    "minecraft:coal",
    "minecraft:bone",
    "minecraft:wither_skeleton_skull"
  ])
  potting_cagedmobs("stalwart_dungeons:nether_keeper", "end", false, 2, [
    "stalwart_dungeons:ancient_fire",
    "minecraft:nether_brick",
    "create:sturdy_sheet"
  ])
  potting_cagedmobs("stalwart_dungeons:reinforced_blaze", "end", false, 2, [
    "stalwart_dungeons:blaze_armor_scrap",
    "minecraft:blaze_rod"
  ])
  potting_cagedmobs("stalwart_dungeons:shelterer_without_armor", "end", false, 2, [
    "stalwart_dungeons:void_crystal"
  ])
  potting_cagedmobs("stalwart_dungeons:shelterer", "end", false, 2, ["stalwart_dungeons:void_crystal"])
  //#endregion
  //#region - The Aether
  potting_cagedmobs("aether:aechor_plant", "aether", false, 2, ["aether:aechor_petal"])
  potting_cagedmobs("aether:aerbunny", "aether", false, 1, ["string"])
  ...
  potting_cagedmobs("aether:mimic", "aether", false, 2, [
    "minecraft:chest",
  ...
  potting_cagedmobs("aether:moa", "aether", false, 2, ["aether:holystone"])
  ...
  potting_cagedmobs("aether:sheepuff", "aether", false, 1, [
    "minecraft:mutton",
    "minecraft:white_wool",
    "minecraft:light_gray_wool",
    "minecraft:gray_wool",
  ...
  potting_cagedmobs("ancient_aether:aeronautic_leaper", "aether", false, 2, [
    "ancient_aether:corrupted_aeronautic_stone"
  ])
  potting_cagedmobs("lost_aether_content:aerwhale_king", "aether", false, 3, [
    "aether:blue_aercloud",
    "lost_aether_content:platinum_key"
  ])
  //#endregion
  //#region - The Twilight Forest
  potting_cagedmobs("twilightforest:alpha_yeti", "twilight", false, 3, [
  ...
  potting_cagedmobs("twilightforest:bighorn_sheep", "twilight", false, 1, [
    "minecraft:mutton",
    "minecraft:white_wool",
    "minecraft:light_gray_wool",
    "minecraft:gray_wool",
  ...
  potting_cagedmobs("twilightforest:carminite_broodling", "twilight", false, 1, [
    "minecraft:string",
    "minecraft:spider_eye"
  ])
  potting_cagedmobs("twilightforest:carminite_ghastguard", "twilight", false, 2, [
    "minecraft:gunpowder",
    "minecraft:ghast_tear"
  ])
  potting_cagedmobs("twilightforest:carminite_ghastling", "twilight", false, 2, [
    "minecraft:gunpowder",
    "minecraft:ghast_tear"
  ])
  potting_cagedmobs("twilightforest:carminite_golem", "twilight", false, 2, [
    "twilightforest:towerwood",
    "minecraft:iron_ingot"
  ])
  potting_cagedmobs("twilightforest:death_tome", "twilight", false, 2, ["minecraft:book", "minecraft:paper"])
  potting_cagedmobs("twilightforest:deer", "overworld", false, 1, [
    "minecraft:leather",
    "twilightforest:raw_venison"
  ])
  potting_cagedmobs("twilightforest:deer", "twilight", false, 1, [
    "minecraft:leather",
    "twilightforest:raw_venison"
  ])
  potting_cagedmobs("twilightforest:dwarf_rabbit", "twilight", false, 1, [
    "minecraft:rabbit_hide",
    "minecraft:rabbit",
    "minecraft:rabbit_foot"
  ])
  potting_cagedmobs("twilightforest:fire_beetle", "twilight", false, 2, ["minecraft:gunpowder"])
  potting_cagedmobs("twilightforest:giant_miner", "twilight", false, 2, [
  ...
  potting_cagedmobs("twilightforest:hedge_spider", "twilight", false, 2, [
    "minecraft:string",
    "minecraft:spider_eye"
  ])
  potting_cagedmobs("twilightforest:helmet_crab", "twilight", false, 2, [
    "twilightforest:armor_shard",
    "minecraft:cod"
  ])
  potting_cagedmobs("twilightforest:hydra", "twilight", false, 3, [
  ...
  potting_cagedmobs("twilightforest:king_spider", "twilight", false, 2, [
    "minecraft:string",
    "minecraft:spider_eye"
  ])
  potting_cagedmobs("twilightforest:knight_phantom", "twilight", false, 3, [
    "twilightforest:knightmetal_sword",
    "twilightforest:knightmetal_chestplate"
  ])
  potting_cagedmobs("twilightforest:kobold", "twilight", false, 2, [
    "minecraft:wheat",
    "minecraft:gold_nugget"
  ])
  potting_cagedmobs("twilightforest:lich", "twilight", false, 3, [
    "minecraft:ender_pearl",
    "minecraft:bone",
  ...
  potting_cagedmobs("twilightforest:lower_goblin_knight", "twilight", false, 2, [
    "twilightforest:armor_shard"
  ])
  potting_cagedmobs("twilightforest:maze_slime", "twilight", false, 2, [
    "minecraft:slime_ball",
    "twilightforest:charm_of_keeping_1"
  ])
  potting_cagedmobs("twilightforest:minoshroom", "twilight", false, 3, [
  ...
  potting_cagedmobs("twilightforest:quest_ram", "twilight", false, 2, [
    "minecraft:mutton",
    "minecraft:white_wool",
    "minecraft:light_gray_wool",
    "minecraft:gray_wool",
  ...
  potting_cagedmobs("twilightforest:skeleton_druid", "twilight", false, 2, [
    "minecraft:bone",
    "twilightforest:torchberries"
  ])
  potting_cagedmobs("twilightforest:slime_beetle", "twilight", false, 2, ["minecraft:slime_ball"])
  potting_cagedmobs("twilightforest:snow_queen", "twilight", false, 3, [
    "minecraft:snowball",
    "minecraft:packed_ice",
  ...
  potting_cagedmobs("twilightforest:swarm_spider", "twilight", false, 2, [
    "minecraft:string",
    "minecraft:spider_eye"
  ])
  ...
  potting_cagedmobs("twilightforest:troll", "twilight", false, 2, [
  ...
  potting_cagedmobs("twilightforest:upper_goblin_knight", "twilight", false, 2, [
    "twilightforest:armor_shard"
  ])
  potting_cagedmobs("twilightforest:ur_ghast", "twilight", false, 3, [
  ...
  potting_cagedmobs("undergarden:dweller", "overworld", false, 1, [
    "minecraft:leather",
  ...
  potting_cagedmobs("undergarden:gloomper", "overworld", false, 2, [
    "minecraft:leather",
    "undergarden:raw_gloomper_leg"
  ])
  potting_cagedmobs("undergarden:gwibling", "overworld", false, 1, [
    "minecraft:bone_meal",
    "undergarden:raw_gwibling"
  ])
  potting_cagedmobs("undergarden:mog", "overworld", false, 1, [
    "undergarden:depthrock_pebble",
    "undergarden:mogmoss"
  ])
  potting_cagedmobs("undergarden:muncher", "overworld", false, 2, [
  ...
  potting_cagedmobs("undergarden:smog_mog", "overworld", false, 1, [
    "undergarden:depthrock_pebble",
    "undergarden:blue_mogmoss"
  ])
  potting_cagedmobs("undergarden:sploogie", "overworld", false, 1, [
    "undergarden:depthrock_pebble",
  ...
  potting_cagedmobs("ars_nouveau:blazing_weald_walker", "overworld", false, 1, [
  ...
  potting_cagedmobs("ars_nouveau:cascading_weald_walker", "overworld", false, 1, [
  ...
  potting_cagedmobs("ars_elemental:flashing_weald_walker", "overworld", false, 1, [
    "ars_elemental:yellow_archwood_log",
    "ars_elemental:yellow_archwood_leaves",
    "ars_elemental:yellow_archwood_sapling"
  ])
  potting_cagedmobs("ars_nouveau:flourishing_weald_walker", "overworld", false, 1, [
    "ars_nouveau:green_archwood_log",
    "ars_nouveau:green_archwood_leaves",
    "ars_nouveau:green_archwood_sapling"
  ])
  potting_cagedmobs("ars_nouveau:starbuncle", "overworld", false, 1, [
    "ars_nouveau:starbuncle_shards",
    "ars_nouveau:source_gem"
  ])
  potting_cagedmobs("ars_nouveau:vexing_weald_walker", "overworld", false, 1, [
  ...
  potting_cagedmobs("ars_nouveau:wilden_boss", "overworld", false, 3, [
  ...
  potting_cagedmobs("goblintraders:goblin_trader", "overworld", false, 1, ["minecraft:apple"])
  potting_cagedmobs("goblintraders:vein_goblin_trader", "nether", false, 1, ["minecraft:carrot"])
  //#endregion
  //#region - The Farlanders
  potting_cagedmobs("farlanders:classic_enderman", "overworld", false, 2, [
    "minecraft:ender_pearl",
    "minecraft:chorus_fruit"
  ])
  potting_cagedmobs("farlanders:elder_farlander", "overworld", false, 1, [
  ...
  potting_cagedmobs("farlanders:fanmade_enderman", "overworld", false, 2, [
    "minecraft:ender_pearl",
    "minecraft:chorus_fruit"
  ])
  potting_cagedmobs("farlanders:farlander", "overworld", false, 1, [
    "farlanders:endumium_crystal",
  ...
  potting_cagedmobs("farlanders:mystic_enderman", "overworld", false, 2, [
    "farlanders:mystic_wand_ore",
    "farlanders:mystic_wand_teleport",
    "farlanders:mystic_wand_regen",
    "farlanders:mystic_wand_invisible"
  ])
  potting_cagedmobs("farlanders:titan", "overworld", false, 3, ["farlanders:titan_hide"])
  potting_cagedmobs("farlanders:wanderer", "overworld", false, 1, [
    "farlanders:endumium_crystal",
    "minecraft:slime_ball",
    "minecraft:mycelium",
  ...
  //#endregion
  //#region - Meadow
  potting_cagedmobs("meadow:water_buffalo", "overworld", false, 1, [
    "minecraft:leather",
  ...
  potting_cagedmobs("netherskeletons:basalt_skeleton", "nether", false, 2, [
    "minecraft:basalt",
    "minecraft:bow"
  ])
  potting_cagedmobs("netherskeletons:charred_skeleton", "nether", false, 2, [
    "minecraft:bone",
    "cyclic:netherite_nugget"
  ])
  potting_cagedmobs("netherskeletons:crimson_skeleton", "nether", false, 2, [
    "minecraft:crimson_fungus",
    "minecraft:bone_meal",
  ...
  potting_cagedmobs("netherskeletons:skelly_ghast", "nether", false, 2, [
    "minecraft:soul_soil",
    "minecraft:ghast_tear"
  ])
  potting_cagedmobs("netherskeletons:skelly_piglin", "nether", false, 2, ["minecraft:gold_ingot"])
  potting_cagedmobs("netherskeletons:soul_skeleton", "nether", false, 2, ["minecraft:soul_soil"])
  potting_cagedmobs("netherskeletons:warped_skeleton", "nether", false, 2, [
    "minecraft:warped_fungus",
    "minecraft:bone_meal",
  ...
  potting_cagedmobs("the_bumblezone:bee_queen", "overworld", false, 3, [
    ...
    "the_bumblezone:honey_crystal",
    "minecraft:honey_bottle"
  ])
  potting_cagedmobs("the_bumblezone:beehemoth", "overworld", false, 2, ["the_bumblezone:bee_stinger"])
  potting_cagedmobs("the_bumblezone:honey_slime", "overworld", false, 2, [
    "minecraft:sugar",
    "minecraft:slime_ball"
  ])
  potting_cagedmobs("the_bumblezone:rootmin", "overworld", false, 1, [
