...
ServerEvents.recipes(e => {
  ...
  potting_cagedmobs("minecraft:chicken", "overworld", false, 1, ["minecraft:feather", "minecraft:chicken", "minecraft:egg"])
  ...
  potting_cagedmobs("alexsmobs:frilled_shark", "sea", true, 2, ["alexsmobs:crocodile_scute", "alexsmobs:crocodile_egg"])
  ...
  potting_cagedmobs("aquaculture:atlantic_cod", "sea", true, 1, ["aquaculture:atlantic_cod", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:atlantic_halibut", "sea", true, 1, ["aquaculture:atlantic_halibut", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:atlantic_herring", "sea", true, 1, ["aquaculture:atlantic_herring", "minecraft:bone_meal"])
  ...
  potting_cagedmobs("aquaculture:brown_shrooma", "sea", true, 1, ["aquaculture:brown_shrooma", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:brown_trout", "sea", true, 1, ["aquaculture:brown_trout", "minecraft:bone_meal"])
  ...
  potting_cagedmobs("aquaculture:muskellunge", "sea", true, 1, ["aquaculture:muskellunge", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:pacific_halibut", "sea", true, 1, ["aquaculture:pacific_halibut", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:perch", "sea", true, 1, ["aquaculture:perch", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:pink_salmon", "sea", true, 1, ["aquaculture:pink_salmon", "minecraft:bone_meal"])
  ...
  potting_cagedmobs("aquaculture:rainbow_trout", "sea", true, 1, ["aquaculture:rainbow_trout", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:red_grouper", "sea", true, 1, ["aquaculture:red_grouper", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:red_shrooma", "sea", true, 1, ["aquaculture:red_shrooma", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:smallmouth_bass", "sea", true, 1, ["aquaculture:smallmouth_bass", "minecraft:bone_meal"])
  potting_cagedmobs("aquaculture:starshell_turtle", "sea", true, 1, ["aquaculture:starshell_turtle"])
  potting_cagedmobs("aquaculture:synodontis", "sea", true, 1, ["aquaculture:synodontis", "minecraft:bone_meal"])
  ...
  potting_cagedmobs("cataclysm:the_harbinger", "overworld", false, 3, ["cataclysm:wither_assault_shoulder_weapon", "cataclysm:witherite_block"])
  potting_cagedmobs("cataclysm:the_leviathan", "end", false, 3, ["cataclysm:tidal_claws", "cataclysm:abyssal_egg"])
  potting_cagedmobs("cataclysm:the_watcher", "overworld", false, 3, ["minecraft:redstone", "minecraft:iron_ingot"])
  ...
  //#endregion
  //#region - Eidolon
  potting_cagedmobs("eidolon:giant_skeleton", "overworld", false, 2, ["minecraft:bone", "eidolon:imbued_bones"])
  ...
  potting_cagedmobs("eidolon:wraith", "overworld", false, 2, ["eidolon:tattered_cloth", "eidolon:wraith_heart"])
  potting_cagedmobs("eidolon:zombie_brute", "overworld", false, 2, ["minecraft:rotten_flesh", "minecraft:bone", "eidolon:zombie_heart"])
  //#endregion
  //#region - Enderman Overhaul
  potting_cagedmobs("endermanoverhaul:badlands_enderman", "end", false, 2, ["minecraft:ender_pearl", "endermanoverhaul:tiny_skull"])
  potting_cagedmobs("endermanoverhaul:cave_enderman", "end", false, 2, ["minecraft:ender_pearl", "minecraft:coal", "minecraft:raw_iron", "minecraft:emerald"])
  potting_cagedmobs("endermanoverhaul:coral_enderman", "end", false, 2, ["minecraft:ender_pearl", "endermanoverhaul:bubble_pearl"])
  potting_cagedmobs("endermanoverhaul:crimson_forest_enderman", "end", false, 2, ["minecraft:ender_pearl", "endermanoverhaul:crimson_pearl", "minecraft:crimson_fungus"])
  potting_cagedmobs("endermanoverhaul:dark_oak_enderman", "end", false, 2, ["minecraft:ender_pearl"])
  potting_cagedmobs("endermanoverhaul:desert_enderman", "end", false, 2, ["minecraft:ender_pearl", "minecraft:emerald"])
  potting_cagedmobs("endermanoverhaul:end_enderman", "end", false, 2, ["minecraft:ender_pearl", "endermanoverhaul:corrupted_pearl", "minecraft:chorus_fruit", "endermanoverhaul:enderman_tooth"])
  potting_cagedmobs("endermanoverhaul:end_islands_enderman", "end", false, 2, ["minecraft:ender_pearl", "endermanoverhaul:ancient_pearl"])
  potting_cagedmobs("endermanoverhaul:flower_fields_enderman", "end", false, 2, ["minecraft:ender_pearl"])
  potting_cagedmobs("endermanoverhaul:ice_spikes_enderman", "end", false, 2, ["minecraft:ender_pearl", "endermanoverhaul:icy_pearl", "minecraft:packed_ice"])
  potting_cagedmobs("endermanoverhaul:mushroom_fields_enderman", "end", false, 2, ["minecraft:ender_pearl", "minecraft:red_mushroom"])
  potting_cagedmobs("endermanoverhaul:nether_wastes_enderman", "end", false, 2, ["minecraft:ender_pearl", "minecraft:bone"])
  potting_cagedmobs("endermanoverhaul:savanna_enderman", "end", false, 2, ["minecraft:ender_pearl", "minecraft:acacia_log"])
  potting_cagedmobs("endermanoverhaul:snowy_enderman", "end", false, 2, ["minecraft:ender_pearl", "endermanoverhaul:icy_pearl", "minecraft:snowball"])
  potting_cagedmobs("endermanoverhaul:soulsand_valley_enderman", "end", false, 2, ["minecraft:ender_pearl", "endermanoverhaul:soul_pearl", "minecraft:bone"])
  potting_cagedmobs("endermanoverhaul:swamp_enderman", "end", false, 2, ["minecraft:ender_pearl", "endermanoverhaul:summoner_pearl"])
  potting_cagedmobs("endermanoverhaul:warped_forest_enderman", "end", false, 2, ["minecraft:ender_pearl", "endermanoverhaul:warped_pearl", "minecraft:warped_fungus"])
  potting_cagedmobs("endermanoverhaul:windswept_hills_enderman", "end", false, 2, ["minecraft:ender_pearl", "endermanoverhaul:summoner_pearl"])
  //#endregion
  ...
  potting_cagedmobs("endlessbiomes:shiftling", "end", false, 1, ["endlessbiomes:riftite_shard", "endlessbiomes:shiftling_antenna"])
  //#endregion
  //#region - Enlightend
  ...
  potting_cagedmobs("monsterplus:glow_skeleton", "overworld", false, 2, ["minecraft:bone", "minecraft:arrow", "minecraft:glow_ink_sac", "minecraft:glowstone_dust"])
  ...
  potting_cagedmobs("monsterplus:overgrown_skeleton", "overworld", false, 2, ["minecraft:bone", "minecraft:arrow", "minecraft:glow_berries", "minecraft:vine"])
  ...
  potting_cagedmobs("naturalist:dragonfly", "overworld", false, 1, ["naturalist:azure_froglass", "naturalist:verdant_froglass", "naturalist:crimson_froglass"])
  ...
  potting_cagedmobs("netherite_warden:netheritewarden", "overworld", false, 3, ["minecraft:netherite_ingot", "minecraft:heart_of_the_sea", "minecraft:nether_star", "minecraft:spawner"])
  //#endregion
  //#region - Realm RPG
  ...
  potting_cagedmobs("stalwart_dungeons:awful_ghast", "end", false, 3, ["stalwart_dungeons:awful_crystal", "minecraft:ghast_tear"])
  ...
  potting_cagedmobs("stalwart_dungeons:nether_keeper", "end", false, 2, ["stalwart_dungeons:ancient_fire", "minecraft:nether_brick", "create:sturdy_sheet"])
  potting_cagedmobs("stalwart_dungeons:reinforced_blaze", "end", false, 2, ["stalwart_dungeons:blaze_armor_scrap", "minecraft:blaze_rod"])
  potting_cagedmobs("stalwart_dungeons:shelterer_without_armor", "end", false, 2, ["stalwart_dungeons:void_crystal"])
  ...
  potting_cagedmobs("aether:mimic", "aether", false, 2, ["minecraft:chest", "minecraft:trapped_chest", "aether:golden_amber", "aether:zanite_gemstone", "aether:ambrosium_shard"])
  ...
  potting_cagedmobs("twilightforest:deer", "overworld", false, 1, ["minecraft:leather", "twilightforest:raw_venison"])
  ...
  potting_cagedmobs("ars_nouveau:wilden_boss", "overworld", false, 3, ["ars_nouveau:wilden_spike", "ars_nouveau:wilden_horn", "ars_nouveau:wilden_wing"])
  ...
  potting_cagedmobs("meadow:wooly_cow", "overworld", false, 1, ["minecraft:leather", "minecraft:beef", "meadow:umbra_wool", "meadow:warped_wool", "meadow:highland_wool"])
  //#endregion
  //#region - Nether Skeletons
  potting_cagedmobs("netherskeletons:basalt_skeleton", "nether", false, 2, ["minecraft:basalt", "minecraft:bow"])
  potting_cagedmobs("netherskeletons:charred_skeleton", "nether", false, 2, ["minecraft:bone", "cyclic:netherite_nugget"])
  ...
  potting_cagedmobs("netherskeletons:skelly_ghast", "nether", false, 2, ["minecraft:soul_soil", "minecraft:ghast_tear"])
