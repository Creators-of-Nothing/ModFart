...
ServerEvents.recipes(e => {
  ...
  potting_flux_dust_from_deploying("ars_technica:amethyst_dust", "kubejs:giant_anti_obsidian", 16);
  potting_flux_dust_from_deploying("ars_technica:amethyst_dust", "kubejs:giant_ultimate_obsidian", 64);
  e.custom({
