...
ServerEvents.blockLootTables(e => {
  ...
  potting_ore_drop(["minecraft:nether_quartz_ore", "ancient_aether:aether_quartz_ore"], "minecraft:nether_quartz_ore", "kubejs:raw_quartz")
  ...
  //#endregion
  //#region - Enderite
  potting_ore_drop(["lolenderite:primordial_remnants"], "lolenderite:primordial_remnants", "kubejs:raw_enderite")
  //#endregion
  //#region - Enlightend
  potting_ore_drop(["enlightened_end:malachite_ore"], "enlightened_end:malachite_ore", "kubejs:raw_malachite")
  potting_ore_drop(["enlightened_end:irradium_ore"], "enlightened_end:irradium_ore", "enlightened_end:raw_irradium")
  potting_ore_drop(["enlightened_end:bismuth_ore"], "enlightened_end:bismuth_ore", "enlightened_end:raw_bismuth")
  //#endregion
  //#region - Mekanism
  potting_ore_drop(["mekanism:tin_ore", "mekanism:deepslate_tin_ore"], "mekanism:tin_ore", "mekanism:raw_tin")
  potting_ore_drop(["mekanism:osmium_ore", "mekanism:deepslate_osmium_ore"], "mekanism:osmium_ore", "mekanism:raw_osmium")
  potting_ore_drop(["mekanism:uranium_ore", "mekanism:deepslate_uranium_ore"], "mekanism:uranium_ore", "mekanism:raw_uranium")
  potting_ore_drop(["mekanism:fluorite_ore", "mekanism:deepslate_fluorite_ore"], "mekanism:fluorite_ore", "kubejs:raw_fluorite")
  potting_ore_drop(["mekanism:lead_ore", "mekanism:deepslate_lead_ore"], "mekanism:lead_ore", "mekanism:raw_lead")
  //#endregion
  //#region - RFTools
  potting_ore_drop(
  ...
  potting_ore_drop(["samurai_dynasty:ruby_ore", "samurai_dynasty:deepslate_ruby_ore"], "samurai_dynasty:ruby_ore", "kubejs:raw_ruby")
  potting_ore_drop(["samurai_dynasty:jade_ore", "samurai_dynasty:deepslate_jade_ore"], "samurai_dynasty:jade_ore", "kubejs:raw_jade")
  potting_ore_drop(["samurai_dynasty:aquamarine_ore", "samurai_dynasty:deepslate_aquamarine_ore"], "samurai_dynasty:aquamarine_ore", "kubejs:raw_aquamarine")
  potting_ore_drop(["samurai_dynasty:onyx_ore", "samurai_dynasty:deepslate_onyx_ore"], "samurai_dynasty:onyx_ore", "kubejs:raw_onyx")
  potting_ore_drop(["samurai_dynasty:silver_ore", "samurai_dynasty:deepslate_silver_ore", "eidolon:silver_ore", "eidolon:deep_silver_ore"], "samurai_dynasty:silver_ore", "kubejs:raw_silver")
  //#endregion
  //#region - Stalwart Dungeons
  potting_ore_drop(["stalwart_dungeons:tungsten_ore"], "stalwart_dungeons:tungsten_ore", "stalwart_dungeons:raw_tungsten")
  potting_ore_drop(["stalwart_dungeons:chorundum_ore"], "stalwart_dungeons:chorundum_ore", "kubejs:raw_chorundum")
  //#endregion
  //#region - The Aether
  ...
  potting_ore_drop(["farlanders:endumium_ore", "farlanders:deepslate_endumium_ore"], "farlanders:endumium_ore", "kubejs:raw_endumium")
  //#endregion
  //#region - The Undergarden
  potting_ore_drop(["undergarden:depthrock_cloggrum_ore", "undergarden:shiverstone_cloggrum_ore"], "undergarden:depthrock_cloggrum_ore", "undergarden:raw_cloggrum")
  potting_ore_drop(["undergarden:shiverstone_froststeel_ore"], "undergarden:shiverstone_froststeel_ore", "undergarden:raw_froststeel")
  potting_ore_drop(["undergarden:depthrock_utherium_ore", "undergarden:shiverstone_utherium_ore"], "undergarden:depthrock_utherium_ore", "kubejs:raw_utherium")
  potting_ore_drop(["undergarden:depthrock_regalium_ore", "undergarden:shiverstone_regalium_ore"], "undergarden:depthrock_regalium_ore", "kubejs:raw_regalium")
  //#endregion
  //#endregion
})
//#endregion
...
ServerEvents.recipes(e => {
  ...
  e.remove([
    ...
    { id: /lolenderite:enderite_fragment_from_blasting/ },
    { id: /lolenderite:enderite_fragment_from_smelting/ },
  ...
  e.replaceInput({ input: "samurai_dynasty:steel_nugget" }, "samurai_dynasty:steel_nugget", "mekanism:nugget_steel")
  e.replaceInput({ input: "samurai_dynasty:steel_ingot" }, "samurai_dynasty:steel_ingot", "mekanism:ingot_steel")
  e.replaceInput({ input: "samurai_dynasty:steel_block" }, "samurai_dynasty:steel_block", "mekanism:block_steel")
  //#endregion
  //#region - Replace Output
  ...
  potting_ore_recreation("minecraft:coal", 15, "minecraft:stone", "minecraft:coal_ore")
  potting_ore_recreation("minecraft:coal", 15, "minecraft:deepslate", "minecraft:deepslate_coal_ore")
  potting_ore_recreation("minecraft:coal", 15, "deeperdarker:sculk_stone", "deeperdarker:sculk_stone_coal_ore")
  potting_ore_recreation("minecraft:coal", 15, "deeperdarker:gloomslate", "deeperdarker:gloomslate_coal_ore")
  potting_ore_recreation("minecraft:coal", 15, "meadow:limestone", "meadow:alpine_coal_ore")
  potting_ore_recreation("minecraft:coal", 15, "undergarden:depthrock", "undergarden:depthrock_coal_ore")
  potting_ore_recreation("minecraft:coal", 15, "undergarden:shiverstone", "undergarden:shiverstone_coal_ore")
  potting_ore_recreation("minecraft:coal", 15, "alexscaves:coprolith", "alexscaves:coprolith_coal_ore")
  potting_ore_recreation("minecraft:iron_ingot", 15, "minecraft:stone", "minecraft:iron_ore")
  potting_ore_recreation("minecraft:iron_ingot", 15, "minecraft:deepslate", "minecraft:deepslate_iron_ore")
  potting_ore_recreation("minecraft:iron_ingot", 15, "deeperdarker:sculk_stone", "deeperdarker:sculk_stone_iron_ore")
  potting_ore_recreation("minecraft:iron_ingot", 15, "deeperdarker:gloomslate", "deeperdarker:gloomslate_iron_ore")
  potting_ore_recreation("minecraft:iron_ingot", 15, "meadow:limestone", "meadow:alpine_iron_ore")
  potting_ore_recreation("minecraft:iron_ingot", 15, "undergarden:depthrock", "undergarden:depthrock_iron_ore")
  potting_ore_recreation("minecraft:iron_ingot", 15, "undergarden:shiverstone", "undergarden:shiverstone_iron_ore")
  potting_ore_recreation("minecraft:iron_ingot", 15, "alexscaves:galena", "alexscaves:galena_iron_ore")
  potting_ore_recreation("minecraft:copper_ingot", 15, "minecraft:stone", "minecraft:copper_ore")
  potting_ore_recreation("minecraft:copper_ingot", 15, "minecraft:deepslate", "minecraft:deepslate_copper_ore")
  potting_ore_recreation("minecraft:copper_ingot", 15, "deeperdarker:sculk_stone", "deeperdarker:sculk_stone_copper_ore")
  potting_ore_recreation("minecraft:copper_ingot", 15, "deeperdarker:gloomslate", "deeperdarker:gloomslate_copper_ore")
  potting_ore_recreation("minecraft:copper_ingot", 15, "meadow:limestone", "meadow:alpine_copper_ore")
  potting_ore_recreation("minecraft:gold_ingot", 15, "minecraft:stone", "minecraft:gold_ore")
  potting_ore_recreation("minecraft:gold_ingot", 15, "minecraft:deepslate", "minecraft:deepslate_gold_ore")
  potting_ore_recreation("minecraft:gold_ingot", 15, "minecraft:netherrack", "minecraft:nether_gold_ore")
  potting_ore_recreation("minecraft:gold_ingot", 15, "deeperdarker:sculk_stone", "deeperdarker:sculk_stone_gold_ore")
  potting_ore_recreation("minecraft:gold_ingot", 15, "deeperdarker:gloomslate", "deeperdarker:gloomslate_gold_ore")
  potting_ore_recreation("minecraft:gold_ingot", 15, "meadow:limestone", "meadow:alpine_gold_ore")
  potting_ore_recreation("minecraft:gold_ingot", 15, "undergarden:depthrock", "undergarden:depthrock_gold_ore")
  potting_ore_recreation("minecraft:redstone", 9, "minecraft:stone", "minecraft:redstone_ore")
  potting_ore_recreation("minecraft:redstone", 9, "minecraft:deepslate", "minecraft:deepslate_redstone_ore")
  potting_ore_recreation("minecraft:redstone", 9, "deeperdarker:sculk_stone", "deeperdarker:sculk_stone_redstone_ore")
  potting_ore_recreation("minecraft:redstone", 9, "deeperdarker:gloomslate", "deeperdarker:gloomslate_redstone_ore")
  potting_ore_recreation("minecraft:redstone", 9, "meadow:limestone", "meadow:alpine_redstone_ore")
  potting_ore_recreation("minecraft:redstone", 9, "alexscaves:guanostone", "alexscaves:guanostone_redstone_ore")
  potting_ore_recreation("minecraft:emerald", 15, "minecraft:stone", "minecraft:emerald_ore")
  potting_ore_recreation("minecraft:emerald", 15, "minecraft:deepslate", "minecraft:deepslate_emerald_ore")
  potting_ore_recreation("minecraft:emerald", 15, "deeperdarker:sculk_stone", "deeperdarker:sculk_stone_emerald_ore")
  potting_ore_recreation("minecraft:emerald", 15, "deeperdarker:gloomslate", "deeperdarker:gloomslate_emerald_ore")
  potting_ore_recreation("minecraft:emerald", 15, "meadow:limestone", "meadow:alpine_emerald_ore")
  potting_ore_recreation("minecraft:lapis_lazuli", 15, "minecraft:stone", "minecraft:lapis_ore")
  potting_ore_recreation("minecraft:lapis_lazuli", 15, "minecraft:deepslate", "minecraft:deepslate_lapis_ore")
  potting_ore_recreation("minecraft:lapis_lazuli", 15, "deeperdarker:sculk_stone", "deeperdarker:sculk_stone_lapis_ore")
  potting_ore_recreation("minecraft:lapis_lazuli", 15, "deeperdarker:gloomslate", "deeperdarker:gloomslate_lapis_ore")
  potting_ore_recreation("minecraft:lapis_lazuli", 15, "meadow:limestone", "meadow:alpine_lapis_ore")
  potting_ore_recreation("minecraft:diamond", 15, "minecraft:stone", "minecraft:diamond_ore")
  potting_ore_recreation("minecraft:diamond", 15, "minecraft:deepslate", "minecraft:deepslate_diamond_ore")
  potting_ore_recreation("minecraft:diamond", 15, "deeperdarker:sculk_stone", "deeperdarker:sculk_stone_diamond_ore")
  potting_ore_recreation("minecraft:diamond", 15, "deeperdarker:gloomslate", "deeperdarker:gloomslate_diamond_ore")
  potting_ore_recreation("minecraft:diamond", 15, "meadow:limestone", "meadow:alpine_diamond_ore")
  potting_ore_recreation("minecraft:diamond", 15, "undergarden:depthrock", "undergarden:depthrock_diamond_ore")
  potting_ore_recreation("minecraft:diamond", 15, "undergarden:shiverstone", "undergarden:shiverstone_diamond_ore")
  potting_ore_recreation("minecraft:quartz", 15, "minecraft:netherrack", "minecraft:nether_quartz_ore")
  potting_ore_recreation("minecraft:quartz", 15, "aether:holystone", "ancient_aether:aether_quartz_ore")
  potting_ore_recreation("create:zinc_ingot", 15, "minecraft:stone", "create:zinc_ore")
  potting_ore_recreation("create:zinc_ingot", 15, "minecraft:deepslate", "create:deepslate_zinc_ore")
  potting_ore_recreation("enlightened_end:malachite", 15, "minecraft:end_stone", "enlightened_end:malachite_ore")
  potting_ore_recreation("enlightened_end:irradium_bar", 15, "minecraft:end_stone", "enlightened_end:irradium_ore")
  potting_ore_recreation("enlightened_end:bismuth_ingot", 15, "minecraft:end_stone", "enlightened_end:bismuth_ore")
  potting_ore_recreation("samurai_dynasty:ruby", 15, "minecraft:stone", "samurai_dynasty:ruby_ore")
  potting_ore_recreation("samurai_dynasty:ruby", 15, "minecraft:deepslate", "samurai_dynasty:deepslate_ruby_ore")
  potting_ore_recreation("samurai_dynasty:jade", 15, "minecraft:stone", "samurai_dynasty:jade_ore")
  potting_ore_recreation("samurai_dynasty:jade", 15, "minecraft:deepslate", "samurai_dynasty:deepslate_jade_ore")
  potting_ore_recreation("samurai_dynasty:aquamarine", 15, "minecraft:stone", "samurai_dynasty:aquamarine_ore")
  potting_ore_recreation("samurai_dynasty:aquamarine", 15, "minecraft:deepslate", "samurai_dynasty:deepslate_aquamarine_ore")
  potting_ore_recreation("samurai_dynasty:onyx", 15, "minecraft:stone", "samurai_dynasty:onyx_ore")
  potting_ore_recreation("samurai_dynasty:onyx", 15, "minecraft:deepslate", "samurai_dynasty:deepslate_onyx_ore")
  potting_ore_recreation("samurai_dynasty:silver_ingot", 15, "minecraft:stone", "samurai_dynasty:silver_ore")
  potting_ore_recreation("samurai_dynasty:silver_ingot", 15, "minecraft:deepslate", "samurai_dynasty:deepslate_silver_ore")
  potting_ore_recreation("rftoolsbase:dimensionalshard", 3, "minecraft:stone", "rftoolsbase:dimensionalshard_overworld")
  potting_ore_recreation("rftoolsbase:dimensionalshard", 3, "minecraft:netherrack", "rftoolsbase:dimensionalshard_nether")
  potting_ore_recreation("rftoolsbase:dimensionalshard", 3, "minecraft:end_stone", "rftoolsbase:dimensionalshard_end")
  potting_ore_recreation("stalwart_dungeons:tungsten_ingot", 15, "stalwart_dungeons:soul_bricks", "stalwart_dungeons:tungsten_ore")
  potting_ore_recreation("stalwart_dungeons:chorundum", 15, "stalwart_dungeons:purpur_bricks", "stalwart_dungeons:chorundum_ore")
  potting_ore_recreation("ancient_aether:valkyrum", 1, "aether:holystone", "ancient_aether:valkyrum_ore")
  potting_ore_recreation("aether:ambrosium_shard", 3, "aether:holystone", "aether:ambrosium_ore")
  potting_ore_recreation("aether:zanite_gemstone", 15, "aether:holystone", "aether:zanite_ore")
  potting_ore_recreation("aether:enchanted_gravitite", 15, "aether:holystone", "aether:gravitite_ore")
  potting_ore_recreation("undergarden:cloggrum_ingot", 15, "undergarden:depthrock", "undergarden:depthrock_cloggrum_ore")
  potting_ore_recreation("undergarden:cloggrum_ingot", 15, "undergarden:shiverstone", "undergarden:shiverstone_cloggrum_ore")
  potting_ore_recreation("undergarden:froststeel_ingot", 15, "undergarden:shiverstone", "undergarden:shiverstone_froststeel_ore")
  potting_ore_recreation("undergarden:utherium_crystal", 12, "undergarden:depthrock", "undergarden:depthrock_utherium_ore")
  potting_ore_recreation("undergarden:utherium_crystal", 12, "undergarden:shiverstone", "undergarden:shiverstone_utherium_ore")
  potting_ore_recreation("undergarden:regalium_crystal", 12, "undergarden:depthrock", "undergarden:depthrock_regalium_ore")
  potting_ore_recreation("undergarden:regalium_crystal", 12, "undergarden:shiverstone", "undergarden:shiverstone_regalium_ore")
  potting_ore_recreation("farlanders:endumium_crystal", 12, "minecraft:stone", "farlanders:endumium_ore")
  potting_ore_recreation("farlanders:endumium_crystal", 12, "minecraft:deepslate", "farlanders:deepslate_endumium_ore")
  potting_ore_recreation("mekanism:ingot_tin", 15, "minecraft:stone", "mekanism:tin_ore")
  potting_ore_recreation("mekanism:ingot_tin", 15, "minecraft:deepslate", "mekanism:deepslate_tin_ore")
  potting_ore_recreation("mekanism:ingot_osmium", 15, "minecraft:stone", "mekanism:osmium_ore")
  potting_ore_recreation("mekanism:ingot_osmium", 15, "minecraft:deepslate", "mekanism:deepslate_osmium_ore")
  potting_ore_recreation("mekanism:ingot_uranium", 15, "minecraft:stone", "mekanism:uranium_ore")
  potting_ore_recreation("mekanism:ingot_uranium", 15, "minecraft:deepslate", "mekanism:deepslate_uranium_ore")
  potting_ore_recreation("mekanism:ingot_uranium", 15, "alexscaves:radrock", "alexscaves:radrock_uranium_ore")
  potting_ore_recreation("mekanism:fluorite_gem", 15, "minecraft:stone", "mekanism:fluorite_ore")
  potting_ore_recreation("mekanism:fluorite_gem", 15, "minecraft:deepslate", "mekanism:deepslate_fluorite_ore")
  potting_ore_recreation("mekanism:ingot_lead", 15, "minecraft:stone", "mekanism:lead_ore")
  potting_ore_recreation("mekanism:ingot_lead", 15, "minecraft:deepslate", "mekanism:deepslate_lead_ore")
  potting_ore_recreation("minecraft:netherite_ingot", 15, "minecraft:tuff", "minecraft:ancient_debris")
  potting_ore_recreation("lolenderite:enderite_ingot", 15, "minecraft:tuff", "lolenderite:primordial_remnants")
  //#endregion
  ...
  potting_dust_recreation("lolenderite:enderite_fragment", 6, "kubejs:dust_enderite")
  ...
  potting_dust_recreation("lolenderite:enderite_ingot", 2, "kubejs:dust_enderite")
  //#endregion
  //#region - Ore Duplication (Crédit to XenoArea)
  ...
  potting_ore_duplication({
    ore_list: ["lolenderite:primordial_remnants"],
    ore: "forge:ores/enderite",
    raw: "kubejs:raw_enderite",
    clump: "kubejs:clump_enderite",
    shard: "kubejs:shard_enderite",
    dirty_dust: "kubejs:dirty_dust_enderite",
    dust: "kubejs:dust_enderite",
    crystal: "kubejs:crystal_enderite",
    final_element: "lolenderite:enderite_fragment"
  })
  //#endregion
  //#endregion
  //#region - Adamantite
